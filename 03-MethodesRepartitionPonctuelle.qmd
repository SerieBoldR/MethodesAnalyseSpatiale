...
df_metro <- data.frame(Ville=c("New York", "Paris", "Île de Montréal"),
                       Pop=c(8804000, 2165000, 2004000),
                       Metro=c(424, 309, 68))

df_metro$Densite <- round(df_metro$Metro / (df_metro$Pop /10000), 1)
...
#| warning: false
#| include: true
#| label: fig-ExampleSTKDEanim
#| fig-cap: Visualisation animée de la STKDE
#| fig-align: center
#| out-width: '50%'
...
if(is_latex_output()) {
  knitr::include_graphics("images/Chap03/animated_STKDE.jpg")
}else{
  knitr::include_graphics("images/Chap03/animated_STKDE.gif")
}
```
...
#| warning: false
#| include: true
#| label: fig-spacetimemapSherb
#| fig-cap: Distribution spatio-temporelle de la densité des accidents
#| fig-align: center
#| out-width: '50%'
...
if(is_latex_output()) {
  knitr::include_graphics("images/Chap03/animated_STKDE_sherbrooke.jpg")
}else{
  knitr::include_graphics("images/Chap03/animated_STKDE_sherbrooke.gif")
}
```
