...
::: bloc_notes-body
**Pour un rappel sur le calcul d'une moyenne pondérée**, consultez la section intitulée [*Statistiques descriptives pondérées*](https://laeq.github.io/LivreMethoQuantBolR/sect027.html) [@RBoldAir].
:::
:::
...
::: bloc_notes-body
**Pour un rappel sur l'écart-type**, consultez la section intitulée [*Paramètres de dispersion*](https://laeq.github.io/LivreMethoQuantBolR/sect025.html#sect0253) [@RBoldAir].
:::
:::
...
Pour comparer la dispersion de deux semis de points situés dans des régions de taille différente, il convient de supprimer les effets de taille des deux régions. Pour ce faire, nous divisons la **distance standard** ou la **distance standard pondérée** par la superficie de la région. Cette approche est donc très similaire au [coefficient de variation](https://laeq.github.io/LivreMethoQuantBolR/sect025.html#sect0253) en statistique univariée, soit le rapport entre l'écart-type et la moyenne.
...
Correction à la [section @sec-10031].
:::
:::
...
Correction à la [section @sec-10032].
:::
:::
...
Correction à la [section @sec-10033].
:::
:::
