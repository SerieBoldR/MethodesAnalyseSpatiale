...
Dans le code ci-dessous, nous fixons les heures de départ et d'arrivée à 8 h et à 18 h pour le 3 juin 2024 et un temps de marche maximal de 20 minutes.
...
dateheure.matin <- as.POSIXct("03-06-2024 08:00:00",
                              format = "%d-%m-%Y %H:%M:%S")

dateheure.soir  <- as.POSIXct("03-06-2024 18:00:00",
                              format = "%d-%m-%Y %H:%M:%S")
### Définition du temps de marche maximal
minutes_marches_max <- 15
```
