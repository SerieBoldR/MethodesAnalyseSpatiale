...
library(knitr)
if(is_latex_output()) {
  knitr::include_graphics("images/Chap06/image3D_a.jpg")
}else{
...
library(knitr)
if(is_latex_output()) {
  knitr::include_graphics("images/Chap06/image3D_b.jpg")
}else{
...
library(knitr)
if(is_latex_output()) {
  knitr::include_graphics("images/Chap06/image3D_c.jpg")
}else{
...
#| warning: false
#| include: true
#| label: fig-animated_tnkde
#| fig-cap: Densité spatio-temporelle des collisions routières à Sherbrooke
#| fig-align: center
#| out-width: 85%
...
if(is_latex_output()) {
  knitr::include_graphics("images/Chap06/animated_TNKDE_sherbrooke.jpg")
}else{
  knitr::include_graphics("images/Chap06/animated_TNKDE_sherbrooke.gif")
}
```
